...
deps = {
  "build": {
    "url": "{chromium_git}/chromium/tools/build.git@4c7263517a7f089fd6573cffac2f8bcd828b1390",
  },
  ...
  "infra": {
    "url": "{chromium_git}/infra/infra.git@68b3bb41f4de88592dcb76ca523670bd182beefb",
  },
  ...
  "infra_internal": {
    "url": "{chrome_internal_git}/infra/infra_internal.git@0709acadecf2414ecfd6ca8b957f6b9d8f9f4519",
  ...
  "data/cloud-run": {
    "url": "{chrome_internal_git}/infradata/cloud-run.git@53a9fac8c8e766b1356882b4b690da14c5b0b586",
    "condition": "checkout_internal",
  },

  # Not runtime dependencies, just included for ease of development.
  "data/config": {
    "url": "{chrome_internal_git}/infradata/config.git@d5c027a9d337fe877446985ef8e8570fe2136c57",
    "condition": "checkout_internal",
  },
