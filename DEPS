...
deps = {
  ...
  "infra": {
    "url": "{chromium_git}/infra/infra.git@5fdadf6bd80c300b72664a0028e78d1c41c0d9ea",
  },
  ...
  "data/cloud-run": {
    "url": "{chrome_internal_git}/infradata/cloud-run.git@8e4952ef630457d6d54a235cd948f6b7a2f85abe",
    "condition": "checkout_internal",
  },
