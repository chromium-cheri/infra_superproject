...
deps = {
  ...
  "infra_internal": {
    "url": "{chrome_internal_git}/infra/infra_internal.git@82a3714431edae8f0884a7b31bb397c99207a569",
  ...
  "data/gae": {
    "url": "{chrome_internal_git}/infradata/gae.git@72c775764a6616d6019bcfdfa8898fcec8e5cb34",
    "condition": "checkout_internal",
  },
