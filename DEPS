...
deps = {
  ...
  "infra": {
    "url": "{chromium_git}/infra/infra.git@c1026716c9764ad49f3a8e2c743708f811c11ffc",
  },
  ...
  "release_scripts": {
    "url": "{chrome_internal_git}/chrome/tools/release/scripts.git@eb6ebcdec1f356a2160b11138713cae8adf957d2",
    "condition": "checkout_internal",
  },
}
