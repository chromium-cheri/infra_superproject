...
deps = {
  ...
  "infra_internal": {
    "url": "{chrome_internal_git}/infra/infra_internal.git@de7273be7e50add1659c02712069a9af2c25feef",
  ...
  "data/cloud-run": {
    "url": "{chrome_internal_git}/infradata/cloud-run.git@adea417829a0366e97a6a883a79dc736a3a8beee",
    "condition": "checkout_internal",
  },
  ...
  "data/gae": {
    "url": "{chrome_internal_git}/infradata/gae.git@0164595eec317e48a2f0ffc1c66f63fd76c10651",
    "condition": "checkout_internal",
  },
