...
deps = {
  ...
  "infra": {
    "url": "{chromium_git}/infra/infra.git@5201756875e0405c5c44d0e6d97de653b0d6cfca",
  },
  ...
  "data/k8s": {
    "url": "{chrome_internal_git}/infradata/k8s.git@25ef1b6871405293fa6de95f54c02161f37aa9b3",
    "condition": "checkout_internal",
  },
