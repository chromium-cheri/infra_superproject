...
deps = {
  ...
  "infra_internal": {
    "url": "{chrome_internal_git}/infra/infra_internal.git@b294b4aeed826bdb1996bcc84694a69fa7b895fe",
  ...
  "data/k8s": {
    "url": "{chrome_internal_git}/infradata/k8s.git@65b820075983b152e0827f8b05d2a6ff9d851b1c",
    "condition": "checkout_internal",
  },
