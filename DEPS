...
deps = {
  ...
  "infra": {
    "url": "{chromium_git}/infra/infra.git@25a82c94a09db09ed1772b90c53c1a1d22c214f3",
  },
  ...
  "infra_internal": {
    "url": "{chrome_internal_git}/infra/infra_internal.git@28dcbca7180a4a96c5fab64ca404f17b53f30adb",
    "condition": "checkout_internal",
  },

  "build_internal": {
    "url": "{chrome_internal_git}/chrome/tools/build.git@871d753f97d3148a9bbaf4aabc68856339976d83",
    "condition": "checkout_internal",
  },
  ...
  "systems": {
    "url": "{chrome_internal_git}/chrome-golo/chrome-golo.git@8fc43d3ec2dd3a8ed55dbe48d9e4d9057f77ea64",
    "condition": "checkout_internal",
  },
  ...
  "release_scripts": {
    "url": "{chrome_internal_git}/chrome/tools/release/scripts.git@841250f5e6eafb1fe0598f54ee1116858281056f",
    "condition": "checkout_internal",
  },
