...
deps = {
  ...
  "infra": {
    "url": "{chromium_git}/infra/infra.git@ada1f21e593428895b80fa49310400de60b7bd63",
  },
  ...
  "release_scripts": {
    "url": "{chrome_internal_git}/chrome/tools/release/scripts.git@07a8c6dad0efe1e65bcabbf21edbb9d8caaa1eef",
    "condition": "checkout_internal",
  },
}
